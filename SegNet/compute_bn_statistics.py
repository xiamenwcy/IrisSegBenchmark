...
caffe_root = '/data1/caiyong.wang/program/caffe_summary/caffe_deeplab-fusionNet-SegNet/' 			# Change this to the absolute directoy to SegNet Caffe
import sys
...
def make_test_files(testable_net_path, train_weights_path, num_iterations,
    ...
    dead_outputs = [l for l in test_msg.layer if l.type in ["SoftmaxWithLoss", "SegAccuracy"]]
...
if __name__ == '__main__':
    ...
    minibatch_size = testable_msg.layer[0].image_data_param.batch_size
